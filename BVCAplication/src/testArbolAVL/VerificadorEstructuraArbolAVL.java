...
* 
*/
public class VerificadorEstructuraArbolAVL<T extends Comparable<? super T>> implements IVerificadorEstructuraArbolOrdenado<T>
{
// -----------------------------------------------------------------
// Atributos
// -----------------------------------------------------------------
...
* @param arbol Arbol que se quiere verificar
*/
public VerificadorEstructuraArbolAVL( ArbolAVL<T> arbol )
{
this.arbol = arbol;
}
...
{
if( verificarArbol( arbol ) == false )
throw new EstructuraException( "El arbol no cumple con las invariantes" );
}
...
*/
private boolean verificarArbol( ArbolAVL<T> arbol )
{
